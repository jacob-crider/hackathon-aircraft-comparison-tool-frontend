    ...
    <>
      ...
      {(filteredData1 || filteredData2 || filteredData3) &&
        (() => {
          ...
          const sortedPlanes = [...selectedPlanes].sort(
            (a, b) => b.OverallCabinLength - a.OverallCabinLength
          );
          ...
          selectedPlanes.forEach((selectedPlane) => {
            widths[selectedPlane.FleetId] =
              (selectedPlane.OverallCabinLength / maxCabinLength) * 100 + "%";
          });
            ...
            <>
              ...
              {selectedPlanes.map((plane) => (
                <div key={plane.FleetId} style={{ marginBottom: "20px" }}>
                  <ExteriorAircraftPage
                    plane={plane}
                    widthProp={widths[plane.FleetId]}
                  />
                </div>
              ))}
